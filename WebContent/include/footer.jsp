          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="./contact.jsp" class="py-2 d-block"><span class="icon icon-phone">051)888-0000</span></a></li>
                <li><a href="./contact.jsp" class="py-2 d-block"><span class="icon icon-web">etranger.com</span></a></li>
                <li><a href="./contact.jsp" class="py-2 d-block"><span class="icon icon-envelope">contactcsb119@gmail.com</span></a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
